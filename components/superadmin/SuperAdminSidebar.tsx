...
const NAV = [
  ...
  {
    href: '/superadmin/tarifs',
    label: 'Tarifs',
    icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>,
  },
  {
    href: '/superadmin/fonctionnalites',
...
export default function SuperAdminSidebar({ utilisateur }: { utilisateur: Utilisateur }) {
    ...
    <aside className="w-64 flex-shrink-0 bg-gray-900 text-white flex flex-col h-screen sticky top-0">
      ...
      <div className="px-6 py-5 border-b border-white/10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-bold text-white text-sm">VisitPro</p>
            <p className="text-[10px] text-accent font-semibold uppercase tracking-widest">Super Admin</p>
          </div>
        </div>
      </div>
      ...
      {/* Divider + Mon entreprise */}
      <div className="px-3 py-3 border-t border-white/10">
        <Link href="/admin"
          className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-gray-400 hover:text-white hover:bg-white/10 transition-all">
      ...
      <div className="px-4 py-4 border-t border-white/10">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div className="min-w-0">
            ...
            <p className="text-[10px] text-gray-400 truncate">Super Administrateur</p>
          </div>
        </div>
