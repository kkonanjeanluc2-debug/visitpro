      ...
      <section id="tarifs" className="py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
            ...
            {/* Carte Devis personnalisé */}
            <div className="relative flex flex-col rounded-3xl p-8 border-2 border-dashed border-gray-300 bg-gray-50 shadow-sm">
              <div className="mb-6">
                <p className="text-xs font-bold uppercase tracking-widest mb-1 text-gray-400">
                  Sur mesure
                </p>
                <h3 className="text-2xl font-extrabold text-gray-900">Devis personnalisé</h3>
              </div>

              <div className="mb-6">
                <p className="text-3xl font-extrabold text-gray-900">Sur devis</p>
                <p className="text-sm text-gray-500 mt-2">Tarification adaptée selon la taille de l&apos;équipe et les fonctionnalités souhaitées.</p>
              </div>
              ...
              <ul className="flex-1 space-y-3 mb-8">
                {[
                  ...
                  <li key={item} className="flex items-center gap-3 text-sm">
                    <span className="w-4 h-4 flex-shrink-0 text-green-600">
                      <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" className="w-4 h-4">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" />
                      </svg>
                    </span>
              ...
              <a
                href="https://wa.me/2250708864527?text=Bonjour%2C+je+souhaite+obtenir+un+devis+personnalis%C3%A9+pour+VisitPro."
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 py-3.5 rounded-2xl text-sm font-bold text-white transition-opacity hover:opacity-90 bg-green-500"
              >
