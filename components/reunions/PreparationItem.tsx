      ...
      <div className="space-y-2">
        {data.url && (
          <a
            ...
            className="flex items-center gap-2 text-sm text-[rgb(var(--color-primary-rgb))] hover:underline"
          >
            {data.isFile ? (
              <>
                ...
                <span className="truncate max-w-xs">{data.filename ?? 'Télécharger le fichier'}</span>
              </>
            ) : (
              <>
                <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
